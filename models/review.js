...
// Le code définit le modèle Review utilisé pour représenter les avis. Voici ce que fait chaque partie du code
...
module.exports = (sequelize, DataTypes) => {
    return sequelize.define('Review', {
        ...
        // La colonne rating est de type INTEGER (nombre entier) et est requise. Elle est également soumise à une validation qui vérifie si la valeur se situe entre 1 et 5 (inclus).
        rating: {
            type: DataTypes.INTEGER,
            allowNull: false,
            validate: {
