...
// findAllReviews: Récupère tous les avis sur les espaces de coworking. Les avis incluent également les informations sur l'utilisateur qui les a laissés et sur l'espace de coworking concerné.
...
// createReview: Crée un nouvel avis sur un espace de coworking. Les détails de l'avis, tels que le contenu, la note, l'identifiant de l'utilisateur et l'identifiant de l'espace de coworking, sont fournis dans le corps de la requête.
...
// updateReview: Met à jour un avis existant sur un espace de coworking. Les détails de l'avis mis à jour sont fournis dans le corps de la requête, et l'avis à mettre à jour est identifié par son ID spécifié dans les paramètres de la requête.
exports.updateReview = (req, res) => {
    // Modifier l'avis en base de données qui correspond à l'id spécifié dans les paramètres
    ReviewModel.update(req.body, {
        ...
        if(review === null){
            const msg = "Le commentaire demandé n'existe pas."
        ...
        const msg = "Impossible de mettre à jour le commentaire."
